  ...
  render() {
    return (
      <Overlay id="transaction">
        <h2>Simpl Transaction</h2>
        <p>
          At Simpl our bread and butter comes from our transaction application.
          <br />
          Most of our transactions happen through mobile devices. According to
          our analytics there’s still about 10% of users which are transacting
          on Android 4 devices.
        </p>
        <p>
          I tried to make the experience as interesting as possible, while still
          remaining smooth animations on low-end devices using only transform
          ...
          {this.state.videoLoaded ? (
            ...
            <div>
              ...
              <div className={s.transactionSeeDemo}>
                <IconPlayCircle
                  attributes={{ className: s.transactionPlayCircleIcon }}
                />
              </div>
            </div>
          )}
