...
const OverlayTechnologies = () => (
  <Overlay id="technologies">
    ...
    <p>
      ...
      to get the job done. If you aren’t a conservative like I am, it makes work
      very interesting! The term JS fatigue means JS excitement to me :).
    </p>
    <p>Here are some, but not all, of the technologies I’ve worked with:</p>
    <div className={s.row}>
      <Square
        title="React"
