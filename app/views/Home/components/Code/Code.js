...
class Code extends React.Component {
  constructor() {
    ...
    this.description = (
      <p>
        My {this.intjLink} personality type is as such that, it makes me suited
        for intensive intellectual challenges and creative approaches, so coding
        perfectly suits me. I work on making ui components functional &mdash;
        using cutting-edge technologies &mdash; for all browsers and devices. I
        love thinking about architecture, extendability and am very particular
        about performance and code quality.
      </p>
    );
          ...
          <Card className={s.colorFunction}>
            ...
            >
              <div className={s.colorFunctionTitle}>
                <IconGithub attributes={{ className: s.colorFunctionIcon }} />{" "}
                scss-color-weight
              </div>
              <div className={s.colorFunctionDesc}>
                A SCSS Function which makes a color lighter or darker depending
                on the weight.
              </div>
            </a>
          </Card>
          ...
          <Card colSpan={2} className={s.multiModal}>
            ...
            >
              <div className={s.multiModalTitle}>
                <IconGithub attributes={{ className: s.multiModalIcon }} />{" "}
                MultiModal
              </div>
              <div className={s.multiModalDesc}>
                <p>
                  A typescript/javascript library which supports multiple
                  modals, is mobile friendly and has fancy animations.
                </p>
                <p>Built with #GSAP</p>
              </div>
            </a>
        ...
        content: (
          <Card className={s.railsModal}>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={s.railsModalWrapper}
            >
              <div className={s.railsModalTitle}>
                <IconGithub attributes={{ className: s.railsModalIcon }} />{" "}
                rails-modal-component
              </div>
              <div className={s.railsModalDesc}>
                A modal component for Ruby on Rails, to open up a confirm
                dialog.
              </div>
            </a>
          </Card>
      ...
      },
      {
        ...
        content: (
          <Card className={s.cardOptimization}>
            <CardOverlayToggle
              id="optimization"
              className={s.cardOptimizationImage}
            />
          </Card>
        ),
      },
          ...
          <Card className={s.railsDropdownMenu}>
            ...
            >
              <div className={s.railsDropdownMenuTitle}>
                <IconGithub
                  attributes={{ className: s.railsDropdownMenuIcon }}
                />
      ...
      },
      {
        ...
        content: (
          <Card className={s.cardTechnologies}>
            <CardOverlayToggle
              id="technologies"
              className={s.cardTechnologiesImage}
            />
          </Card>
        ),
      },
        ...
        content: (
          <Card className={s.onTransitionEnd}>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={s.onTransitionEndWrapper}
            >
              <div className={s.onTransitionEndTitle}>
                <IconGithub attributes={{ className: s.onTransitionEndIcon }} />{" "}
                onTransitionEnd
              </div>
              <div className={s.onTransitionEndDesc}>
                A prototype for EventTarget which fires onTransitionEnd and
          ...
          <Card className={s.portfolio}>
            ...
            >
              <div className={s.portfolioTitle}>
                <IconGithub attributes={{ className: s.portfolioIcon }} />{" "}
                portfolio
              </div>
              <div className={s.portfolioDesc}>
                Check out the codebase of this website on github. Powered by
                React, PostCSS, Webpack and Babel.
              </div>
            </a>
          </Card>
        ),
